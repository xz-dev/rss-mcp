...
class RSSStorage:
    ...
    def get_entries(
        ...
        if feed_name:
            search_dirs = [self.entries_dir / feed_name] if (self.entries_dir / feed_name).exists() else []
        else:
    ...
    def get_entry_count(self, feed_name: Optional[str] = None, start_time: Optional[datetime] = None, end_time: Optional[datetime] = None) -> int:
