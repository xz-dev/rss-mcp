...
class TestCLI:
    ...
    def test_feed_add_duplicate(self):
        ...
        with patch("rss_mcp.cli.get_storage") as mock_get_storage:
            ...
            result = self.runner.invoke(
                cli, ["feed", "add", "test-feed", "https://example.com/rss.xml"]
            )
    ...
    def test_feed_list_command(self):
        ...
        with patch("rss_mcp.cli.get_storage") as mock_get_storage:
            ...
            sample_feed = RSSFeed(name="test-feed", title="Test Feed", active=True, entry_count=10)
            sample_feed.sources = [
    ...
    def test_feed_list_verbose(self):
        ...
        with patch("rss_mcp.cli.get_storage") as mock_get_storage:
            ...
            sample_feed = RSSFeed(
                name="test-feed", title="Test Feed", description="Test description", active=True
            )
            sample_feed.sources = []
    ...
    def test_feed_remove_command(self):
        ...
        with patch("rss_mcp.cli.get_storage") as mock_get_storage:
            ...
            result = self.runner.invoke(
                cli, ["feed", "remove", "test-feed"], input="y\n"
            )  # Confirm deletion
    ...
    def test_source_add_command(self):
        ...
        with patch("rss_mcp.cli.get_storage") as mock_get_storage:
            ...
            result = self.runner.invoke(
                cli,
                ["source", "add", "test-feed", "https://example.com/rss2.xml", "--priority", "5"],
            )
    ...
    def test_source_add_nonexistent_feed(self):
        ...
        with patch("rss_mcp.cli.get_storage") as mock_get_storage:
            ...
            result = self.runner.invoke(
                cli, ["source", "add", "nonexistent-feed", "https://example.com/rss.xml"]
            )
    ...
    def test_source_remove_command(self):
        ...
        with patch("rss_mcp.cli.get_storage") as mock_get_storage:
            ...
            result = self.runner.invoke(
                cli, ["source", "remove", "test-feed", "https://example.com/rss.xml"], input="y\n"
            )  # Confirm deletion
    ...
    def test_config_command_set_value(self):
        ...
        with patch("rss_mcp.cli.get_config_manager") as mock_config_mgr:
            ...
            result = self.runner.invoke(cli, ["config", "--key", "http_port", "--value", "9000"])
    ...
    def test_serve_stdio_command(self):
        ...
        with patch("rss_mcp.fastmcp_server.run_fastmcp_stdio") as mock_run:
    ...
    def test_serve_http_command(self):
        ...
        with patch("rss_mcp.fastmcp_server.run_fastmcp_http") as mock_run:
            mock_run.side_effect = KeyboardInterrupt()  # Simulate Ctrl+C
            ...
            assert result.exit_code == 0
            assert "Server stopped" in result.output
            # Verify the server was called with correct parameters
